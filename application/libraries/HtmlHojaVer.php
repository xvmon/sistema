...
<p><b>Equipo de protecci&oacute;n(s)</b></p>';
		...
		foreach ($s8c as $d8c){
			$cont= $cont+1;
			$texto= $texto.'<img src="'.base_url().'public/images/pictogramas/'.$d8c['imagen'].'"/>';
			if ($cont==3){
				$texto= $texto.'<br><br>';
			}
			if ($cont==6){
...
<p><b>Pictograma(s)</b></p>';
	...
	<tr>
		...
		<h3>16 Otras informaciones incluidas las relativas a la preparaci&oacute;n y actualizaci&oacute;n de las hojas de datos de seguridad</h3>
		<b>La informaci&oacute;n se considera correcta, pero no es exhaustiva y se utilizar&aacute; &uacute;nicamente como orientaci&oacute;n, la cual est&aacute; basada en el conocimiento actual de la sustancia qu&iacute;mica o mezcla y es aplicable a las precauciones de seguridad apropiadas para el producto</b>
		<p >'.$s16['texto'].'</p>
